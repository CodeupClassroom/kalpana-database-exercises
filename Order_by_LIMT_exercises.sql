...
-- and order your results returned by first name. (709 observations)
...
-- a. In your comments, answer: What was the first and last name in the first row of the results?
--  (10397	1955-11-11	Irena	Reutenauer	M	1993-05-21)

-- b. What was the first and last name of the last person in the table?
--  (497788	1958-11-25	Vidya	Simmen	M	1988-03-25)
...
-- order your results returned by first name and then last name.  (709 observations)
...
-- a. In your comments, answer: What was the first and last name in the first row 
-- of the results? (46986	1964-10-15	Irena	Acton	M	1992-07-11)

-- b. What was the first and last name of the last person in the table? 
-- (97971	1956-07-14	Vidya	Zweizig	M	1986-12-22)
...
-- and order your results returned by last name and then first name. (709 observations)
...
-- b. What was the first and last name of the last person in the table? 
-- (479435	1959-07-10	Maya	Zyda	M	1987-08-23)
...
-- Sort the results by their employee number. (899 rows)
...
-- Ramzi	Erde - first row	
-- Tadahiro	Erde - last row
...
-- the name of the oldest employee (hire date or birth date?).
SELECT * 
FROM employees
WHERE last_name LIKE 'e%e'
ORDER BY hire_date;
...
-- b. and the name of the youngest employee who was hired first.
SELECT *
FROM employees
WHERE hire_date LIKE '199%'
AND birth_date LIKE '%-12-25'
...
The first five results are your first page. The five after that would be your second
page, etc. Update the query to find the tenth page of results.
