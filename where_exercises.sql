...
-- Enter a comment with the number of records returned. (709 observations or rows)

SELECT *
FROM employees
WHERE first_name IN ('Irena', 'Vidya', 'Maya');

-- 3. Find all employees with first names 'Irena', 'Vidya', or 'Maya', as in Q2,
-- but use OR instead of IN.
-- Enter a comment with the number of records returned. 
-- Does it match number of rows from Q2? (709 observations; it matches.)
...
-- 4. Find all employees with first names 'Irena', 'Vidya', or 'Maya', using OR, AND 
-- who is male. Enter a comment with the number of records returned. (441 observations)
...
-- Enter a comment with the number of employees whose last name starts with E. (7330 observations)
...
-- Enter a comment with the number of employees whose last name starts or ends with E. (30_723 observations)
...
-- Enter a comment with the number of employees whose last name starts and ends with E. (899 observations)
...
-- Enter a comment with the number of employees returned. (842 observations)
...
-- Enter a comment with the number of employees returned. (362 observations)
...
-- Enter a comment with the number of records returned. (1873 observations)
...
-- How many employees are found? (547 observations)
